...
import naturePng from './images/enoch_nature.jpg'
...
export {
    linkedInLogo, instragramLogo, githubLogo, selfPortrait, 
    pythonLogo, javaLogo, typescriptLogo, htmlCssLogo, 
    reactLogo, angularLogo, naturePng
};
